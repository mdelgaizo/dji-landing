...
export default function Hero() {
  const items = [
    { label: 'eyebrow', content: 'Sky Hunter' },
    { label: 'h1', content: null },
    { label: 'desc', content: null },
    { label: 'buttons', content: null },
    { label: 'indicators', content: null },
  ]
  ...
  return (
    <section
      ...
      style={{ background: 'linear-gradient(135deg, #0a0a0f 0%, #0d1520 40%, #050a0f 100%)' }}
    >
      <div
      ...
      <span style={{ display: 'none' }}>{items.length}</span>
    </section>
  )
}
